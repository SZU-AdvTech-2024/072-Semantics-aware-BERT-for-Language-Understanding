...
class MrpcProcessor(DataProcessor):
    ...
    def get_train_examples(self, data_dir):
        """See base class."""
        logger.info("LOOKING AT {}".format(os.path.join(data_dir, "train.tsv_tag")))
        return self._create_examples(
            self._read_tsv(os.path.join(data_dir, "train.tsv_tag")), "train")
...
class MnliProcessor(DataProcessor):
  ...
  def get_dev_examples(self, data_dir):
    """See base class."""
    return self._create_examples(
        self._read_tsv(os.path.join(data_dir, "dev_matched.tsv_tag_label")),
        "dev_matched")
  ...
  def get_diag_examples(self, data_dir):
    """See base class."""
    return self._create_examples(  #must change the
        self._read_tsv(os.path.join(data_dir, "diagnostic.tsv_tag")), "diag")
...
class QnliProcessor(DataProcessor):
  ...
  def get_dev_examples(self, data_dir):
    """See base class."""
    return self._create_examples(
        self._read_tsv(os.path.join(data_dir, "dev.tsv_tag")),
        "dev_matched")
